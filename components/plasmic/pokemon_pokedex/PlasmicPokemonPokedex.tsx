...
// Plasmic Project: 3s5pUaZ99gQQTsDiADXr9R
// Component: xviZXng_Dv-b
...
import PageLayout from "../../PageLayout"; // plasmic-import: wLTnGnYTJqKP/component
...
import projectcss from "./plasmic.module.css"; // plasmic-import: 3s5pUaZ99gQQTsDiADXr9R/projectcss
import sty from "./PlasmicPokemonPokedex.module.css"; // plasmic-import: xviZXng_Dv-b/css
...
function PlasmicPokemonPokedex__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    getPokemon: usePlasmicDataOp(() => {
      return {
        sourceId: "iVQ4baK1mfipqTiiS1c5bQ",
        opId: "663991b1-8f87-4f6a-8786-9db53ed7fdd2",
        userArgs: {},
        cacheKey: `plasmic.$.663991b1-8f87-4f6a-8786-9db53ed7fdd2.$.`,
            ...
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__inLge)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                        ...
                        $steps["useIntegration"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "iVQ4baK1mfipqTiiS1c5bQ",
                                  opId: "c25e8b26-4f37-4c5d-b090-c6134cd81dc1",
                                  userArgs: {
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__cdGnI)}
                    >
                      {(() => {
                        const child$Props = {
                          ...
                          data: {
                            sourceId: "iVQ4baK1mfipqTiiS1c5bQ",
                            opId: "44318fbd-a316-4f84-9d59-d9473b236b62",
                            userArgs: {},
                            cacheKey: `plasmic.$.${(() => {
                              try {
                                return "getSchema";
                            ...
                            })()}.$.1QeyYuHcPBnn.$.44318fbd-a316-4f84-9d59-d9473b236b62.$.`,
                            invalidatedKeys: null,
                            roleId: null
                          },
                          dataFormItems: (() => {
                            ...
                            $steps["defaultSubmit"] = true
                              ? (() => {
                                  const actionArgs = {
                                    dataOp: {
                                      sourceId: "iVQ4baK1mfipqTiiS1c5bQ",
                                      opId: "3c5bf234-6fdc-4fb5-a36b-18beb8e72888",
                                      userArgs: {
                  ...
                  <AntdModal
                      ...
                      $steps["postgresUpdateMany"] = true
                        ? (() => {
                            const actionArgs = {
                              dataOp: {
                                sourceId: "iVQ4baK1mfipqTiiS1c5bQ",
                                opId: "0a50e573-db06-4134-b562-60370b10b564",
                                userArgs: {
                    ...
                    wrapClassName={classNames({
                      [sty["pcls_2oxzhA5yIL7j"]]: true
                    })}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__khDt2)}
                    >
                      {(() => {
                        const child$Props = {
                          className: classNames(
                          ...
                          data: {
                            sourceId: "iVQ4baK1mfipqTiiS1c5bQ",
                            opId: "defcb635-2be4-4733-9a56-b36acf58dcc4",
                            userArgs: {
                            ...
                            })()}.$.oY1V3AeuDtdo.$.defcb635-2be4-4733-9a56-b36acf58dcc4.$.`,
                            invalidatedKeys: null,
                            roleId: null
                          },
                          dataFormItems: (() => {
